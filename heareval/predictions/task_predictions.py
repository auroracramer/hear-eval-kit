...
from typing import (
    Any, Callable, DefaultDict, Dict, List, Optional, Set, Tuple, Union
)
...
from heareval.predictions.events import create_events_from_prediction
...
class SplitMemmapDataset(Dataset):
    ...
    def __init__(
        ...
        embedding_filename = embedding_path.joinpath(f"{split_name}.embeddings.npy")
